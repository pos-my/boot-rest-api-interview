...
class BookControllerTest {
    ...
    void setUp() {
        ...
        testBook.setTitle("A Little Life");
        testBook.setAuthor("Hanya Yanagihara");
        testBook.setPublishedYear("2015");
    ...
    void getBook_success() throws URISyntaxException {
        var uri = new URI(baseUrl + "/book/" + testBook.getBookId());
